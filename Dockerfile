...
RUN go get github.com/op/go-logging & go get github.com/streadway/amqp & go get github.com/golang/protobuf/proto & go get gopkg.in/mgo.v2 & go get -d github.com/tensorflow/tensorflow/tensorflow/go & go get gopkg.in/yaml.v2
